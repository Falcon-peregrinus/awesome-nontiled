...
function new(arg)
   ...
   -- end
    ...
    local menu = {
        { "Мультимеда", programs["AudioVideo"], utils.lookup_icon({ icon = 'applications-multimedia.png' }) },
        { "Графика", programs["Graphics"], utils.lookup_icon({ icon = 'applications-graphics.png' }) },
        { "Игры", programs["Game"], utils.lookup_icon({ icon = 'applications-games.png' }) },
        { "Обучение", programs["Education"], utils.lookup_icon({ icon = 'applications-science.png' }) },
        { "Разработка", programs["Development"], utils.lookup_icon({ icon = 'applications-development.png' }) },
        { "Интернет", programs["Network"], utils.lookup_icon({ icon = 'applications-internet.png' }) },        
        { "Офис", programs["Office"], utils.lookup_icon({ icon = 'applications-office.png' }) },
        { "Разное", programs["Other"], utils.lookup_icon({ icon = 'applications-other.png' }) },
        { "Системные", programs["System"], utils.lookup_icon({ icon = 'applications-system.png' }) },
        { "Утилиты", programs["Utility"], utils.lookup_icon({ icon = 'applications-accessories.png' }) },
        { "Настройки", programs["Settings"], utils.lookup_icon({ icon = 'preferences-desktop.png' }) },
    }
